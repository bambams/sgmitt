...
al5poly::IAnimation::Ptr AssetManager::getAnimation(
...
al5poly::ALLEGRO_BITMAP_Ptr AssetManager::getBitmap(
        const std::string & name) const
{
...
al5poly::IAnimation::Ptr AssetManager::loadAnimation(
        ...
        ...)
{
    ...
    al5poly::IAnimation::Ptr animation(
            new al5poly::Animation(sprites));
...
al5poly::ALLEGRO_BITMAP_Ptr AssetManager::loadBitmap(
        const std::string & name,
        ...
        const bool magicPinkAlpha = false)
{
    ...
    al5poly::ALLEGRO_BITMAP_Ptr bitmap(
